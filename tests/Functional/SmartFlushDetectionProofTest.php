...
final class SmartFlushDetectionProofTest extends AbstractFunctionalTestCase
{
    ...
    public function testAutoIncrementEntityRequiresSingleFlushWithDeferredDirectPersistence(): void
    {
        self::bootKernel();
        ...
        self::assertSame(1, $this->flushCount, sprintf(
            "Auto-increment entities should trigger exactly 1 flush cycle after deferred direct persistence.\n".
