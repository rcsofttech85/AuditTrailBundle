...
{
    /**
     * @param array<\Rcsofttech\AuditTrailBundle\Contract\AuditLogInterface> $audits
     */
     ...
     */
    public function auditToArray(\Rcsofttech\AuditTrailBundle\Contract\AuditLogInterface $audit): array
    {
        return [
            'id' => $audit->getId(),
