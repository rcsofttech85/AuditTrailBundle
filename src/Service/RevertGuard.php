...
final readonly class RevertGuard
{
    ...
    {
        $this->assertSignatureIsValid($log, $verifySignature);
        $this->assertNotAlreadyReverted($log);
    }

    private function assertSignatureIsValid(AuditLog $log, bool $verifySignature): void
    {
    ...
    private function assertNotAlreadyReverted(AuditLog $log): void
    {
