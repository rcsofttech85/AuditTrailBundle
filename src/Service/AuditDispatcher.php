...
readonly class AuditDispatcher
{
    ...
    public function dispatch(\Rcsofttech\AuditTrailBundle\Contract\AuditLogInterface $audit, EntityManagerInterface $em, string $phase, ?UnitOfWork $uow = null): bool
    {
        $context = [
            'phase' => $phase,
            'em' => $em,
    ...
    private function persistFallback(\Rcsofttech\AuditTrailBundle\Contract\AuditLogInterface $audit, EntityManagerInterface $em, string $phase): void
    {
