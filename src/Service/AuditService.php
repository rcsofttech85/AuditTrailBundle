        ...
        try {
            ...
            if ([] === $ids) {
                if (method_exists($entity, 'getId')) {
                    ...
                    return (null !== $id && (is_scalar($id) || $id instanceof \Stringable)) ? (string) $id : self::PENDING_ID;
                }

                return self::PENDING_ID;
            }

            $idValues = array_filter(array_map(fn ($v) => is_scalar($v) || $v instanceof \Stringable ? (string) $v : '', $ids), fn ($id) => '' !== $id);
