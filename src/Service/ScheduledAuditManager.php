...
class ScheduledAuditManager
{
    ...
    /** @var array<int, array{entity: object, audit: \Rcsofttech\AuditTrailBundle\Contract\AuditLogInterface, is_insert: bool}> */
    ...
    public function schedule(object $entity, \Rcsofttech\AuditTrailBundle\Contract\AuditLogInterface $audit, bool $isInsert): void
    {
    ...
    /**
     * @return array<int, array{entity: object, audit: \Rcsofttech\AuditTrailBundle\Contract\AuditLogInterface, is_insert: bool}>
     */
    ...
    private function dispatchCreatedEvent(object $entity, \Rcsofttech\AuditTrailBundle\Contract\AuditLogInterface $audit): \Rcsofttech\AuditTrailBundle\Contract\AuditLogInterface
    {
