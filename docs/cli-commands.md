...
- The purge verification path streams matching rows through the repository iterable API, which uses less memory than eager loading during large purge runs.
